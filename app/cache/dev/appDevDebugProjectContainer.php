...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'validator.unique.date.exam' => 'getValidator_Unique_Date_ExamService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\My\\FormRPBundle\\Entity'))), 'My\\FormRPBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('MyFormRPBundle' => 'My\\FormRPBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_74a06c457421a6c0a7f7697dd01e107b0279c36f93f981a12edba2c61c55c820');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\My\\FormRPBundle/Resources/views'), 'MyFormRP');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('date_majority' => 'validator.unique.date.exam', 'validator.expression' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\EmailValidator' => 'validator.email', 'security.validator.user_password' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique')));
    ...
    /**
     * Gets the 'validator.unique.date.exam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \My\FormRPBundle\Validator\Constraint\DateMajorityValidator A My\FormRPBundle\Validator\Constraint\DateMajorityValidator instance.
     */
    protected function getValidator_Unique_Date_ExamService()
    {
        return $this->services['validator.unique.date.exam'] = new \My\FormRPBundle\Validator\Constraint\DateMajorityValidator();
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('55a4274f73a89')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MyFormRPBundle' => 'My\\FormRPBundle\\MyFormRPBundle',
